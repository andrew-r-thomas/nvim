...
require('lazy').setup({
  ...
  -- {
  --   dir = '/Users/andrewthomas/pinky/personal/pinky/pinky_nvim',
  --   config = function()
  --     local pky = require 'pinky_nvim'
  --
  --     pky.setup {
  --       default_lib = '/Users/andrewthomas/pinky_test',
  --     }
  --
  --     vim.keymap.set('n', '<leader>pnp', function()
  --       pky.new_page {}
  --     end)
  --
  --     vim.keymap.set('n', '<leader>pns', function()
  --       vim.ui.input({ prompt = 'schema name: ' }, function(input)
  --         pky.new_schema {
  --           schema_name = input,
  --         }
  --       end)
  --     end)
  --
  --     vim.keymap.set('n', '<leader>pnb', function()
  --       vim.ui.input({ prompt = 'book name: ' }, function(input)
  --         pky.new_book {
  --           book_name = input,
  --         }
  --       end)
